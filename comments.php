	...
	<div class="commentlist-item">
		<div <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
			...
			<div class="commentlist-holder">
				<?php edit_comment_link( __( '(Edit)', 'base' ), '<p class="edit-link">', '</p>' ); ?>
				<p class="meta"><?php comment_date(); ?> <?php _e( 'at', 'base' ); ?> <?php comment_time(); ?>, <?php comment_author_link(); ?> <?php _e( 'said:', 'base' ); ?></p>
